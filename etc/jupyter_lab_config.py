...
c.ServerApp.root_dir = os.getenv('JUPYTER_ROOTDIR')
c.ServerApp.base_url = os.getenv("JUPYTER_BASEURL", "/")
c.ServerApp.iopub_data_rate_limit=100000000.0 #(bytes/sec)
c.ServerApp.rate_limit_window=10.0 #(secs)

# # HTTPS 적용은 Traefik 에서 진행되므로 자체 SSL 적용은 사용하지 않음
# if 'JUPYTER_CERT' in os.environ and 'JUPYTER_CERT_KEY' in os.environ:
#     c.ServerApp.certfile = os.getenv('JUPYTER_CERT')
#     c.ServerApp.keyfile = os.getenv('JUPYTER_CERT_KEY')

# sets a password if JUPYTER_PASSWD is set in the environment
if 'JUPYTER_PASSWD' in os.environ:
    #c.ServerApp.token = passwd(os.environ['JUPYTER_PASSWD']) 
    c.ServerApp.password = passwd(os.environ['JUPYTER_PASSWD'])
    del os.environ['JUPYTER_PASSWD']
...
#  Default: '/home/skp/.jupyter/lab/user-settings'
# c.LabApp.user_settings_dir = '/home/skp/.jupyter/lab/user-settings'
...
#  Default: '/home/skp/.jupyter/lab/workspaces'
# c.LabApp.workspaces_dir = '/home/skp/.jupyter/lab/workspaces'
